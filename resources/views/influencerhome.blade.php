...
<div class="row mr-tab-border">
    ...
    ?>
              <div class="col-lg-4 col-md-6 col-sm-12 pb-4">
                  ...
                  <img src="{{asset($offer->picture_url)}}" class="img-fluid" alt="">
                  <div class="pt-3 pb-3 pr-4 text-right">
                    <span class="ml-5 mr-offer-box-title">مشخصات پیشنهاد</span>
                    <span class="mr-offer-box-detail">{{$offer -> title}}</span>
                  </div>
                  <div class="pt-3 pb-3 pr-4 text-right">
                    <span class="ml-5 mr-offer-box-title">تعداد باقی‌مانده</span>
                    <span class="mr-offer-box-detail">{{$offer->numbers - $offer->reserved}}نفر</span>
                  </div>
                  <div class="pt-3 pb-3 pr-4 text-right">
                    <span class="ml-5 mr-offer-box-title align-top">تاریخ</span>
                    <span class="mr-offer-box-detail"><span class="d-block">{{ $offer -> exp_date }}</span>
                    <span class="d-block">{{ $offer -> start_date }}</span></span>
                  </div>
                  <div class="pt-3 pb-3 pr-4 text-right">
                    <span class="ml-5 mr-offer-box-title align-middle">زمان</span>
                    <span class="mr-offer-box-detail"><span>{{ $offer -> end_time }}</span><span class="oniva-color">-</span>
                    <span>{{ $offer -> start_time }}</span></span>
                  </div>
